...
public class IronTypeMaterialConfiguration extends MaterialConfiguration {
	...
	public static class Builder {
		...
		public Builder tier(MiningTier miningTier, MineabilityTier mineabilityTier) {
